...
#include "dragon/tree/lowest-common-ancestor.hpp"
 ...
 */
  ...
  dragon::LowestCommonAncestor<dragon::Tree<int>> tree_lca(tree);
  std::cout<<"LCA of nodes 1 and 4 = "<<tree_lca.lca(1,4)<<"\n";
  std::cout<<"LCA of nodes 11 and 4 = "<<tree_lca.lca(11,4)<<"\n";
  std::cout<<"LCA of nodes 1 and 14 = "<<tree_lca.lca(1,14)<<"\n";
  std::cout<<"LCA of nodes 13 and 16 = "<<tree_lca.lca(13,16)<<"\n";
