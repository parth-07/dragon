...
typename ForwardIterator::value_type maximum_subset_xor_value(ForwardIterator first,
...
typename Container::value_type maximum_subset_xor_value(const Container& container) {
